...
- **Parameters:**
  ...
  - `filter_users_with` (string, optional): Filter messages with a specific user in threads and DMs. Must use explicit format: `@username`, `U1234567890` (user ID), or `D1234567890` (DM channel ID). Plain usernames without @ are not accepted.
  - `filter_users_from` (string, optional): Filter messages from a specific user. Must use explicit format: `@username`, `U1234567890` (user ID), or `D1234567890` (DM channel ID). Plain usernames without @ are not accepted.
